...
subroutine loadtxt_int(filename, d)
...
subroutine loadtxt_complex_1Darray(filename, d)
! Loads a 1D array from a text file.
!
! Arguments
! ---------
...
subroutine loadtxt_complex_2Darray(filename, d)
! Loads a 2D array from a text file.
!
! Arguments
! ---------
...
subroutine savetxt_real_1Darray(filename, d)
! Saves a 1D array into a textfile.
!
! Arguments
! ---------
!
...
subroutine savetxt_real_2Darray(filename, d)
...
subroutine savetxt_complex_1Darray(filename, d)
! Saves a 1D array into a textfile.
!
! Arguments
! ---------
!
character(len=*), intent(in) :: filename  ! File to save the array to
complex(dp*2), intent(in) :: d(:)         ! The 1D array to save
!
! Example
! -------
!
...
subroutine savetxt_complex_2Darray(filename, d)
! Saves a 2D array into a textfile.
!
! Arguments
! ---------
